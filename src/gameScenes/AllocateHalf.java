...
public class AllocateHalf {
	...
	public void glDraw(long time){
		...
		GL11.glPushMatrix();
			...
			if(activate && aniTime > System.currentTimeMillis()){
				float r = 1-((aniTime-System.currentTimeMillis())/1000.0f);
			...
			if(deactivate && aniTime > System.currentTimeMillis()){
				GLTextureManager.unbindTexture();
				float r = 1-((aniTime-System.currentTimeMillis())/500.0f);				
	...
	public void activate(){
		activate = true;
		aniTime = System.currentTimeMillis()+1000;
	}

	public void deactivate() {
		deactivate = true;
		aniTime = System.currentTimeMillis()+500;
	}
